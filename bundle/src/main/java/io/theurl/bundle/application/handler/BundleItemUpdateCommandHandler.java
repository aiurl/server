...
import io.theurl.bundle.application.command.BundleItemUpdateCommand;
...
public class BundleItemUpdateCommandHandler implements Handler<BundleItemUpdateCommand, Void> {
    private final BundleRepository repository;

    public BundleItemUpdateCommandHandler(BundleRepository repository) {
        this.repository = repository;
    }

    @Override
    public CompletableFuture<Void> handleAsync(BundleItemUpdateCommand message, MessageContext context) {
        ...
        aggregate.updateItem(message.getItemId(), message.getTitle(), message.getDescription(), message.getImage());
